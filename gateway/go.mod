module github.com/bluenotbloo/boys-help-boys/gateway

go 1.22

require (
	github.com/bluenotbloo/boys-help-boys/common v0.0.0
...
replace github.com/bluenotbloo/boys-help-boys/common => ../common
